        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {specializedServices.map((service, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="text-secondary mb-4 p-3 bg-muted dark:bg-primary/20 rounded-xl inline-flex w-fit group-hover:bg-primary group-hover:text-white transition-colors duration-300 relative z-10 shadow-sm">
                {service.icon}
              </div>
